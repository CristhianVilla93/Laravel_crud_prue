...
@section('contenido')
    ...
    <div class="card">
        ...
        <h5 class="card-header">Crud Docente</h5>
        <div class="card-body">
            ...
            <p>
                <a class="btn btn-primary" href="{{ route("docentes.create") }}">Agregar nuevo alumno</a>
            </p>
            ...
            <table class="table table-sm table-bordered"> 
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $items->nombre }}</td>
                        <td>{{ $items->correo }}</td>
                        <td>{{ $items->contrase }}</td>
                        
                        <td>
                            <form action="{{ route("docentes.edit", $items->id) }}" method="GET">
                        ...
                        <td>
                            <form action="{{ route("docentes.delet", $items->id) }}" method="GET">
