...
@section('contenido')
    ...
    <div class="card">
        ...
        <h5 class="card-header">Crud Alumno</h5>
        <div class="card-body">
            ...
            <p>
                <a class="btn btn-primary" href="{{ route("alumnos.create") }}">Agregar nuevo alumno</a>
            </p>
            ...
            <table class="table table-sm table-bordered"> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route("alumnos.edit", $items->id) }}" method="GET">
                        ...
                        <td>
                            <form action="{{ route("alumnos.delet", $items->id) }}" method="GET">
